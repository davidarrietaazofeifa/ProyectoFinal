...
public class Cliente extends Usuario {
    ...
    // Arreglo estático compartido por todos los clientes
    ...
    // Constructor completo: datos de cliente + datos de usuario
    public Cliente(String nombre, String apellidos, String ciudad, String direccion,
        ...
        // Llamas al constructor de Usuario
    ...
    // ====== Registro desde Usuario.agregarUsuario() ======
    ...
    // ---------------- Métodos requeridos ----------------
    // Este agregarCliente sirve si tienes un menú de "gestión directa de clientes"
    public void agregarCliente() {
        ...
        do {
            ...
            passwordValido = validacionPasswordMinimo(password); // método heredado de Usuario
            if (!passwordValido) {
                JOptionPane.showMessageDialog(null, "El password no cumple con los 8 caracteres mínimos.");
            }
        } while (!passwordValido);

        Estados estado = util.seleccionarEstado(); // igual que en Usuario
    ...
    public void inactivarCliente() {
        ...
        if (c.getEstado() == Estados.Activo) { // getEstado() heredado de Usuario
